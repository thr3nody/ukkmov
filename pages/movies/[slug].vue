<template>
  <div class="max-w-screen-lg mx-auto py-8 px-4 space-y-8">
    <div class="mb-4">
      <iframe
        v-if="movieDetail?.trailerLink"
        class="aspect-video w-full h-full rounded-md"
        :src="movieDetail?.trailerLink"
        frameborder="0"
        allowfullscreen
      ></iframe>
      ...
      <div class="lg:col-span-2">
        ...
        <div class="mb-4 p-4 border rounded-md">
          ...
          <p
            v-if="reviewMessage"
            class="mt-2 text-sm"
            :class="reviewSuccess ? 'text-green-500' : 'text-red-500'"
          >
            {{ reviewMessage }}
          </p>
        </div>
      ...
      <div v-if="movieDetail!">
        ...
        <Card class="p-2">
          <CardTitle class="mb-2">
            <img
              v-if="movieDetail?.posterPath"
              :src="`/posters/${movieDetail?.posterPath}`"

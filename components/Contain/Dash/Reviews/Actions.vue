<template>
  <div class="flex gap-2 items-center py-4">
    <Input class="max-w-sm" placeholder="Filter reviews..." :modelValue="props.table.getColumn('movieTitle')?.getFilterValue() as string
      " @update:modelValue="(value: any) => table.getColumn('movieTitle')?.setFilterValue(value)
        " />
